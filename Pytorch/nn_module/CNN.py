...
cifar10_t = dsets.CIFAR10(path, download=False, train=True, transform=transform)
cifar10_val = dsets.CIFAR10(path, download=False, train=False, transform=transform)
